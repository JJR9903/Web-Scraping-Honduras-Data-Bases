...
municipios= {
    ...
    'COMAYAGUA':['COMAYAGUA','AJUTERIQUE','EL ROSARIO','ESQUÍAS','HUMUYA','LA LIBERTAD','LAMANÍ','LA TRINIDAD','LEJAMANÍ','MEÁMBAR','MINAS DE ORO','OJOS DE AGUA','SAN JERÓNIMO','SAN JOSÉ DE COMAYAGUA'],
